...
DECLARE_CONFIG(Config,
    ...
    CONFIG_VALUE(ForceFPS, bool, "Fixed FPS", true, "While rendering, slows down the game to ensure FPS is what is set. Disables capturing hitsound audio")
